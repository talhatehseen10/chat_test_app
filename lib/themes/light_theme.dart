...
class LightTheme {
  ...
  static const Color buttonBackgroundColor = Color(0xffE32527);
  static const Color buttonBackgroundColor2 = Color(0xff0F8A9B);
  ...
  static const Color fillColor = Color(0xffDDDDDD);
